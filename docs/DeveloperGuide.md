...
4. **Provide better visualisation for View**: The current view shown in `RightSidePanel` displays student records for 13 weeks, but does not provide a visual representation of the week numbers.
