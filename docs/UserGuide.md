...
| WEEK_NUMBER         | Integer from 1 to 13 (inclusive).                                                                                                                                                                                                                                                                                                                                        | Represents tutorial week.                                                                                                                                        |
| ATTENDANCE_SCORE    | Integer 0 (absent) or 1 (present).                                                                                                                                                                                                                                                                                                                                       | Binary value.                                                                                                                                                    |
| SUBMISSION_SCORE    | Integer 0 (not submitted) or 1 (submitted).                                                                                                                                                                                                                                                                                                                              | Binary value.                                                                                                                                                    |
| PARTICIPATION_SCORE | Integer from 0 to 5 (inclusive)                                                                                                                                                                                                                                                                                                                                          | Higher score indicates better participation.                                                                                                                     |
