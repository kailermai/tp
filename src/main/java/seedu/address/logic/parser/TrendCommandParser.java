...
/**
 * Parses input arguments and creates a new TrendCommand object
 */
public class TrendCommandParser implements Parser<TrendCommand> {
    ...
    public TrendCommand parse(String args) throws ParseException {
        ...
        try {
            ...
            return new TrendCommand(index);
        } catch (ParseException pe) {
            throw new ParseException(
                    String.format(MESSAGE_INVALID_COMMAND_FORMAT, TrendCommand.MESSAGE_USAGE), pe);
        }
    }
}
